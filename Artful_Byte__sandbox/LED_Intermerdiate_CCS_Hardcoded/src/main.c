...
static void test_blink_led(void)
{
    ...
    io_set_select(IO_TEST_LED, led_config.select);
    io_set_direction(IO_TEST_LED, led_config.dir);
    io_set_out(IO_TEST_LED, led_config.out);
    io_set_resistor(IO_TEST_LED, led_config.resistor);
